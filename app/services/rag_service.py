"""
app/services/rag_service.py — Bloque 3.1 / actualizado Bloque 3.3-3.4

Bloque 3.4 — Cambios:
  - Usa get_embeddings() de app.core.llm_provider en lugar de instanciar
    OpenAIEmbeddings directamente.
  - Cuando OLLAMA_ENABLED=true usa OllamaEmbeddings (sin API key).
  - ADVERTENCIA: los índices FAISS son incompatibles entre proveedores de
    embeddings distintos. Si cambiás de proveedor, borrá ./vector_stores/.
"""
...
from app.core.llm_provider import get_llm, get_embeddings   # ← Bloque 3.4
...
class RAGService:
    ...
    def __init__(self):
        # Bloque 3.4: embeddings resueltos según OLLAMA_ENABLED
